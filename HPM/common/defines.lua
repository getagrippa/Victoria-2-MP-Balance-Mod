...
country = {
	...
	NONCORE_TAX_PENALTY = -0.075, -- -7.5% for each non-core in state
	...
	NAVAL_BASE_NON_CORE_SUPPLY_SCORE = 0.1, -- modifier for supply score for naval bases that are not in core provinces.
